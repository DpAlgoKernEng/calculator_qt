...
// 这是计算器应用程序的主程序文件，负责初始化Qt应用程序和主窗口。
//

#include <QApplication>     // 包含Qt应用程序类
#include "calculatorwindow.h"     // 包含计算器主窗口类头文件

/**
 * @brief 应用程序的主函数，计算器应用程序的入口点
 * @param argc 命令行参数个数
 * @param argv 命令行参数数组
 * @return 应用程序退出码
 * 
 ...
 * 2. 创建CalculatorWindow实例，即计算器的主窗口
 * 3. 设置窗口标题、大小等属性
 * 4. 显示主窗口
 * 5. 进入Qt事件循环，等待用户交互
 */
auto main(int argc, char *argv[]) -> int
{
    ...
    // 设置窗口标题，显示计算器名称和使用的Qt版本
    window.setWindowTitle("计算器 - Qt6版");
